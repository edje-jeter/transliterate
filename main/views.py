...
def correlate_arpa_to_unicode(warpa):
    ...
    arpa_respell = {'B': 'b', 'G': 'g', 'JH': 'j', 'D': 'd', 'HH': 'h', 'V': 'v', 'Z': 'z', 'ZH': 'zh', 'Y': 'y', 'K': 'k', 'L': 'l', 'M': 'm', 'N': 'n', 'S': 's', 'F': 'f', 'P': 'p', 'CH': 'ch', 'R': 'r', 'SH': 'sh', 'T': 't', 'AY': 'ai', 'AW': 'ao', 'EY': 'ei', 'OW': 'o', 'OY': 'oi', 'DH': 'dh', 'TH': 'th', 'AE': 'a', 'AA': 'ah', 'AX': '\u018F', 'EH': 'eh', 'IY': 'ee', 'IH': 'i', 'AO': 'aw', 'UW': 'ew', 'UH': 'uu', 'AH': 'u', 'NG': 'ng', 'ER': 'er', 'W': 'w'}
